...
public class GreyImageTest extends TestCase {
	...
	public void testPartA() throws Exception {
		...
		// assert
		assertEquals(2, greyImage.countWhitePixels());
	}
...
private static int[][] beforeCallToProcessImage = { { 221, 184, 178, 84, 135 }, { 84, 255, 255, 130, 84 }, { 78, 255, 0, 0, 78 }, { 84, 130, 255, 130, 84 } };
	...
	public void testPartB() throws Exception {
		...
		// assert
		GreyImage gy = new GreyImage();
		System.out.println("Right Ex.");
		gy.printThePix(afterCallToProcessImage);
		System.out.println("Your Stuffz");
		gy.printThePix(greyImage.getPixelValues());
